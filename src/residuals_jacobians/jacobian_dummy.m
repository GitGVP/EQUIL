function J = jacobian_dummy(r,x,epsilon,omega,kinetic_profiles,q,qp,P0,P1,P2,dof_count,Nb,Sbc,P_templates,M_extended,equation_of_state)
	Nq = numel(r);
	Ns = numel(Sbc);
	nRes = 3+Nb+Ns;
	t2_c    = x(1:dof_count);
