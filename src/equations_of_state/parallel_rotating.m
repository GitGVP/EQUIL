function [dbetapardB0, dbetapardr, dbetapardB, dbetapardR, d2betapardB2, ...
    ...
    d3betapardrdR2, betapar, betaperp] = parallel_rotating(kinetic_profiles,r,RR,BB,varargin)
