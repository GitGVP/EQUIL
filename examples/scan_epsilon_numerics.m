...
base_args = {'beta',0.8, 's0', 4, 'A0',1, 'debug', 4, ...
            'residuals_fun', @residuals_hyb, 'equation_of_state',@isotropic, ...
             'jacobian_fun', @jacobian_rotation, 'nk', 30, ...
              'm',15, 'om_pts', 200, 'Nb', 1};
...
outerloop_pvals = [3, 5, 10]; % numeric vector of values
